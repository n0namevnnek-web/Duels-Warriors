...
local Config = {
    ...
    -- [3] Scripts & Links
    MainScriptURL   = "https://raw.githubusercontent.com/n0namevnnek-web/Duels-Warriors/refs/heads/main/Duel%20Warriors", -- The raw URL of your main script
    ...
    HubDescription  = "Duel Warriors " -- The text shown below the title
}
